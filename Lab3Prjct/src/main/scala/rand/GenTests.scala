...
object GenTests {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // TODO: Task 8.4.a) Generator of list of 10 Boolen values with probability 0.5
    val b10: Gen[List[Boolean]] = Gen.booleans(0.5).list(10)
    val (bs, _) = b10(3293)
    for (b <- bs) println(b)
    println

    // TODO: Task 8.4.b) Generator of list of 10 Int values from 0 to 100
    val i10: Gen[List[Int]] = intsTo(100).list(10)
    val (is, _) = i10(40591)
    for (i <- is) println(i)
    println

    // TODO: Task 8.4.c) Generator for list with 10 lists with length between 2 and 10 of integers from 0 to 100
    val nIntListLists:  Gen[List[List[Int]]] =
      intsTo(100).listsOfLengths(2, 10)list(10)
